...
const App = () => {
  return (
    ...
    >
      <div className="absolute top-0 z-[-2] h-screen w-screen bg-regal-light dark:bg-neutral-950/50 text-black dark:text-neutral-100 transition-all ease-in-out duration-150"></div>
