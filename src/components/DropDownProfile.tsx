  ...
  return (
    <>
      {isAuthenticated ? (
        ...
        <Link
          to="signin"
          className="flex items-center transition ease-in-out gap-2 text-sm px-4 py-1.5 font-semibold bg-gradient-to-r from-purple-600 via-pink-600 to-purple-600 rounded-full hover:scale-105"
        >
          Get started
        </Link>
      )}
