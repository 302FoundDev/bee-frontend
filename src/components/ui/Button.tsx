...
export const Button = ({
  ...
  const variants = {
    ...
    base: 'rounded-md w-full px-4 text-neutral-100 py-1.5 text-neutral-100 hover:bg-transparent hover:text-neutral-800 dark:hover:text-neutral-100 dark:hover:bg-neutral-850',
  }
