...
export const Footer = () => {
  ...
  return (
    <footer className="flex flex-col justify-between w-full gap-2 px-4 py-2 mx-auto text-white opacity-75 appearance-none bg-neutral-900 border-zinc-800 lg:flex-row md:flex-row">
