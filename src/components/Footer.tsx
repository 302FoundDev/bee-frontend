...
export const Footer = () => {
  ...
  return (
    <footer className="px-4 py-6 text-white w-fullmx-auto bg-neutral-900 border-zinc-800">
      <section className="flex flex-col justify-between mx-auto max-w-screen-2xl lg:flex-row md:flex-row">
